...
export const DEFAULT_METADATA_TITLE = 'Kutchey Store';
export const DEFAULT_METADATA_DESCRIPTION =
	'Unleash your inner chef with our versatile blenders that can handle any recipe, from soups to sauces and beyond.';
...
export const DEV_API = import.meta.env.VITE_VENDURE_PUBLIC_URL;
export const PROD_API = import.meta.env.VITE_VENDURE_PUBLIC_URL;
