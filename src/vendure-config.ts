...
export const config: VendureConfig = {
    ...
    plugins: [
        AssetServerPlugin.init({
            route: 'assets',
            assetUploadDir: path.join(__dirname, '../public/assets'),
        ...
        EmailPlugin.init({
            devMode: true,
            outputPath: path.join(__dirname, '../public/email/test-emails'),
            route: 'mailbox',
            handlers: defaultEmailHandlers,
            templatePath: path.join(__dirname, '../public/email/templates'),
            globalTemplateVars: {
