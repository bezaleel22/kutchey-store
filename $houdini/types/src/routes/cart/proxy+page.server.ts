...
export const actions = {
    ...
    updateItem: async (event: import('./$types').RequestEvent) => {
        const id = event.url.searchParams.get("id") as string
        const quantity = Number(event.url.searchParams.get("qty"))
    ...
    removeItem: async (event: import('./$types').RequestEvent) => {
        const id = event.url.searchParams.get("id") as string
    ...
    calculateShipping: async (event: import('./$types').RequestEvent) => {
        const id = event.url.searchParams.get("id") as string
    ...
    applyCoupon: async (event: import('./$types').RequestEvent) => {
        const id = event.url.searchParams.get("id") as string
