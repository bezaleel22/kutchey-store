export type CreateCustomerAddress = {
    readonly "input": CreateCustomerAddress$input;
    readonly "result": CreateCustomerAddress$result;
};

export type CreateCustomerAddress$result = {
    /**
...
export type CreateCustomerAddress$input = {
    input: CreateAddressInput;
};

export type CreateCustomerAddress$optimistic = {
    /**
     * Create a new Customer Address
    */
    readonly createCustomerAddress?: {
...
export type CreateCustomerAddress$artifact = {
