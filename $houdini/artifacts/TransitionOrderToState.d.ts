...
export type TransitionOrderToState = {
    readonly "input": TransitionOrderToState$input;
    readonly "result": TransitionOrderToState$result;
};

export type TransitionOrderToState$result = {
    /**
     * Transitions an Order to a new state. Valid next states can be found by querying `nextOrderStates`
    */
    readonly transitionOrderToState: {
        readonly " $fragments": {
            OrderDetail: {};
        };
    } & (({
...
export type TransitionOrderToState$input = {
    state: string;
};

export type TransitionOrderToState$optimistic = {
    /**
     * Transitions an Order to a new state. Valid next states can be found by querying `nextOrderStates`
    */
    readonly transitionOrderToState?: {} & (({
...
export type TransitionOrderToState$artifact = {
