...
export type AddPaymentToOrder = {
    readonly "input": AddPaymentToOrder$input;
    readonly "result": AddPaymentToOrder$result;
};

export type AddPaymentToOrder$result = {
    /**
     * Add a Payment to the Order
    */
    readonly addPaymentToOrder: {
        readonly " $fragments": {
            OrderDetail: {};
        };
    } & (({
...
export type AddPaymentToOrder$input = {
    input: PaymentInput;
};

export type AddPaymentToOrder$optimistic = {
    /**
     * Add a Payment to the Order
    */
    readonly addPaymentToOrder?: {} & (({
...
export type AddPaymentToOrder$artifact = {
    "name": "AddPaymentToOrder";
    "kind": "HoudiniMutation";
    "hash": "31dd76194db0b1aa4feca17fd10f97fa11c278417333be2e30974b19012f3988";
    "raw": `mutation AddPaymentToOrder($input: PaymentInput!) {
...
`;
    ...
    "selection": {
        "fields": {
            "addPaymentToOrder": {
                "type": "AddPaymentToOrderResult";
                "keyRaw": "addPaymentToOrder(input: $input)";
                "selection": {
                    "abstractFields": {
                        "fields": {
                            "Order": {
                        ...
                        "typeMap": {
                            "IneligiblePaymentMethodError": "ErrorResult";
                            "NoActiveOrderError": "ErrorResult";
                            "OrderPaymentStateError": "ErrorResult";
                            "OrderStateTransitionError": "ErrorResult";
                            "PaymentDeclinedError": "ErrorResult";
                            "PaymentFailedError": "ErrorResult";
                        };
                    };
                    "fields": {
                        "__typename": {
