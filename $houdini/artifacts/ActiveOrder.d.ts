export type ActiveOrder = {
    readonly "input": ActiveOrder$input;
    readonly "result": ActiveOrder$result | undefined;
};

export type ActiveOrder$result = {
    /**
...
export type ActiveOrder$input = null;

export type ActiveOrder$artifact = {
    "name": "ActiveOrder";
    "kind": "HoudiniQuery";
