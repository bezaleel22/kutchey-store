...
import { GetOrderPaymentMethods$result, GetOrderPaymentMethods$input } from "../artifacts/GetOrderPaymentMethods";
import { GetOrderPaymentMethodsStore } from "../plugins/houdini-svelte/stores/GetOrderPaymentMethods";
import { GetOrderShippingMethods$result, GetOrderShippingMethods$input } from "../artifacts/GetOrderShippingMethods";
...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[CollectionsStore, Collections$result, Collections$input], [CollectionStore, Collection$result, Collection$input], [AvailableCountriesStore, AvailableCountries$result, AvailableCountries$input], [EligibleShippingMethodsStore, EligibleShippingMethods$result, EligibleShippingMethods$input], [EligiblePaymentMethodsStore, EligiblePaymentMethods$result, EligiblePaymentMethods$input], [ActiveCustomerAddressesStore, ActiveCustomerAddresses$result, ActiveCustomerAddresses$input], [ActiveCustomerStore, ActiveCustomer$result, ActiveCustomer$input], [ActiveCustomerOrdersStore, ActiveCustomerOrders$result, ActiveCustomerOrders$input], [ProductStore, Product$result, Product$input], [ProductsStore, Products$result, Products$input], [SearchProductStore, SearchProduct$result, SearchProduct$input], [GetOrderShippingMethodsStore, GetOrderShippingMethods$result, GetOrderShippingMethods$input], [GetOrderPaymentMethodsStore, GetOrderPaymentMethods$result, GetOrderPaymentMethods$input], [ActiveOrderStore, ActiveOrder$result, ActiveOrder$input], [ArderByCodeStore, ArderByCode$result, ArderByCode$input], [PromotionsStore, Promotions$result, Promotions$input]];
};