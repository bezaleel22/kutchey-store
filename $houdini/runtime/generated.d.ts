...
export declare type CacheTypeDef = {
    ...
    lists: {};
    queries: [[AvailableCountriesStore, AvailableCountries$result, AvailableCountries$input], [EligibleShippingMethodsStore, EligibleShippingMethods$result, EligibleShippingMethods$input], [EligiblePaymentMethodsStore, EligiblePaymentMethods$result, EligiblePaymentMethods$input], [ActiveOrderStore, ActiveOrder$result, ActiveOrder$input], [ArderByCodeStore, ArderByCode$result, ArderByCode$input], [ProductStore, Product$result, Product$input], [ProductsStore, Products$result, Products$input], [SearchProductStore, SearchProduct$result, SearchProduct$input], [CollectionsStore, Collections$result, Collections$input], [CollectionStore, Collection$result, Collection$input], [PromotionsStore, Promotions$result, Promotions$input], [ActiveCustomerAddressesStore, ActiveCustomerAddresses$result, ActiveCustomerAddresses$input], [ActiveCustomerStore, ActiveCustomer$result, ActiveCustomer$input], [ActiveCustomerOrdersStore, ActiveCustomerOrders$result, ActiveCustomerOrders$input]];
};